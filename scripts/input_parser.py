...
parser.add_argument("--annotation_feature", type=str, default="ALL",
...
parser.add_argument("--node_score_algorithm", type=str, default="simple",
                    help="Select which calculation algorithm you want to utilize to calculate the node scores in your tree.")
parser.add_argument("--ignore_gap_positions", type=str, default="N",
